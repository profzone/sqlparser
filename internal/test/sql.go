// Code generated by goyacc -o ./internal/test/sql.go ./internal/test/sql.y. DO NOT EDIT.

//line ./internal/test/sql.y:2
package sqlparser
...
//line ./internal/test/sql.y:71
		{
			setParseTree(yylex, yyDollar[1].stmt)
		}
	case 2:
		yyDollar = yyS[yypt-2 : yypt+1]
//line ./internal/test/sql.y:75
		{
			setParseTree(yylex, yyDollar[1].stmt)
		}
	case 3:
		yyDollar = yyS[yypt-3 : yypt+1]
//line ./internal/test/sql.y:79
		{
			setParseTree(yylex, yyDollar[1].stmt)
		}
	case 4:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:84
		{
			yyVAL.stmt = yyDollar[1].selStmt
		}
	case 5:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:88
		{
			yyVAL.stmt = yyDollar[1].sdbStmt
		}
	case 6:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:92
		{
			yyVAL.stmt = yyDollar[1].cdbStmt
		}
	case 7:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:96
		{
			yyVAL.stmt = yyDollar[1].smmStmt
		}
	case 8:
		yyDollar = yyS[yypt-7 : yypt+1]
//line ./internal/test/sql.y:103
		{
			sel := &SelectStatement{}
...
//line ./internal/test/sql.y:156
	...
	case 19:
		yyDollar = yyS[yypt-3 : yypt+1]
//line ./internal/test/sql.y:162
		{
			yyVAL.dimens = yyDollar[3].dimens
		}
	case 20:
		yyDollar = yyS[yypt-0 : yypt+1]
//line ./internal/test/sql.y:166
		{
			yyVAL.dimens = nil
		}
	case 21:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:171
		{
			yyVAL.dimens = []*Dimension{yyDollar[1].dimen}
		}
	case 22:
		yyDollar = yyS[yypt-3 : yypt+1]
//line ./internal/test/sql.y:175
		{
			yyVAL.dimens = append(yyDollar[3].dimens, yyDollar[1].dimen)
		}
	case 23:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:180
		{
	...
	case 24:
		yyDollar = yyS[yypt-2 : yypt+1]
//line ./internal/test/sql.y:186
		{
			yyVAL.expr = yyDollar[2].expr
		}
	case 25:
		yyDollar = yyS[yypt-0 : yypt+1]
//line ./internal/test/sql.y:190
		{
			yyVAL.expr = nil
		}
	case 26:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:195
		{
			yyVAL.expr = yyDollar[1].expr
		}
	case 27:
		yyDollar = yyS[yypt-3 : yypt+1]
//line ./internal/test/sql.y:199
		{
			yyVAL.expr = &BinaryExpr{Op: yyDollar[2].int, LHS: yyDollar[1].expr, RHS: yyDollar[3].expr}
		}
	case 28:
		yyDollar = yyS[yypt-3 : yypt+1]
//line ./internal/test/sql.y:203
		{
			yyVAL.expr = &BinaryExpr{Op: yyDollar[2].int, LHS: yyDollar[1].expr, RHS: yyDollar[3].expr}
	...
	case 29:
		yyDollar = yyS[yypt-3 : yypt+1]
//line ./internal/test/sql.y:209
		{
			yyVAL.expr = &BinaryExpr{Op: yyDollar[2].int, LHS: yyDollar[1].expr, RHS: yyDollar[3].expr}
		}
	case 30:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:214
		{
			yyVAL.int = yyDollar[1].int
		}
	case 31:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:218
		{
			yyVAL.int = yyDollar[1].int
		}
	case 32:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:222
		{
			yyVAL.int = yyDollar[1].int
		}
	case 33:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:226
		{
			yyVAL.int = yyDollar[1].int
		}
	case 34:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:230
		{
			yyVAL.int = yyDollar[1].int
		}
	case 35:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:234
		{
			yyVAL.int = yyDollar[1].int
		}
	case 36:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:239
		{
			yyVAL.expr = &VarRef{Val: yyDollar[1].str}
		}
	case 37:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:243
		{
			yyVAL.expr = &NumberLiteral{Val: yyDollar[1].float64}
		}
	case 38:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:247
		{
			yyVAL.expr = &IntegerLiteral{Val: yyDollar[1].int64}
		}
	case 39:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:251
		{
			yyVAL.expr = &DurationLiteral{Val: yyDollar[1].tdur}
		}
	case 40:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:255
		{
			yyVAL.expr = &StringLiteral{Val: yyDollar[1].str}
		}
	case 41:
		yyDollar = yyS[yypt-3 : yypt+1]
//line ./internal/test/sql.y:260
		{
			yyVAL.sortfs = yyDollar[3].sortfs
		}
	case 42:
		yyDollar = yyS[yypt-0 : yypt+1]
//line ./internal/test/sql.y:264
		{
			yyVAL.sortfs = nil
		}
	case 43:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:269
		{
			yyVAL.sortfs = []*SortField{yyDollar[1].sortf}
		}
	case 44:
		yyDollar = yyS[yypt-3 : yypt+1]
//line ./internal/test/sql.y:273
		{
			yyVAL.sortfs = append(yyDollar[3].sortfs, yyDollar[1].sortf)
		}
	case 45:
		yyDollar = yyS[yypt-1 : yypt+1]
//line ./internal/test/sql.y:278
		{
			yyVAL.sortf = &SortField{Name: yyDollar[1].str}
		}
	case 46:
		yyDollar = yyS[yypt-2 : yypt+1]
//line ./internal/test/sql.y:282
		{
			yyVAL.sortf = &SortField{Name: yyDollar[1].str, Ascending: yyDollar[2].bool}
		}
	case 47:
		yyDollar = yyS[yypt-2 : yypt+1]
//line ./internal/test/sql.y:286
		{
			yyVAL.sortf = &SortField{Name: yyDollar[1].str, Ascending: yyDollar[2].bool}
		}
	case 48:
		yyDollar = yyS[yypt-2 : yypt+1]
//line ./internal/test/sql.y:291
		{
			yyVAL.int = int(yyDollar[2].int64)
		}
	case 49:
		yyDollar = yyS[yypt-0 : yypt+1]
//line ./internal/test/sql.y:295
		{
			yyVAL.int = 0
		}
	case 50:
		yyDollar = yyS[yypt-2 : yypt+1]
//line ./internal/test/sql.y:300
		{
			yyVAL.sdbStmt = &ShowDatabasesStatement{}
		}
	case 51:
		yyDollar = yyS[yypt-3 : yypt+1]
//line ./internal/test/sql.y:305
		{
			yyVAL.cdbStmt = &CreateDatabaseStatement{Name: yyDollar[3].str}
		}
	case 52:
		yyDollar = yyS[yypt-5 : yypt+1]
//line ./internal/test/sql.y:310
		{
