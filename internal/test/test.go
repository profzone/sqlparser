// Code generated by goyacc -o ./internal/test/test.go -p Calc ./internal/test/test.y. DO NOT EDIT.

//line ./internal/test/test.y:8

package main

import __yyfmt__ "fmt"

//line ./internal/test/test.y:9
...
//line ./internal/test/test.y:49
		{
			fmt.Printf("%d\n", CalcDollar[1].val)
		}
	case 4:
		CalcDollar = CalcS[Calcpt-3 : Calcpt+1]
//line ./internal/test/test.y:53
		{
			regs[CalcDollar[1].val] = CalcDollar[3].val
		}
	case 5:
		CalcDollar = CalcS[Calcpt-3 : Calcpt+1]
//line ./internal/test/test.y:59
		{
			CalcVAL.val = CalcDollar[2].val
		}
	case 6:
		CalcDollar = CalcS[Calcpt-3 : Calcpt+1]
//line ./internal/test/test.y:61
		{
			CalcVAL.val = CalcDollar[1].val + CalcDollar[3].val
		}
	case 7:
		CalcDollar = CalcS[Calcpt-3 : Calcpt+1]
//line ./internal/test/test.y:63
		{
			CalcVAL.val = CalcDollar[1].val - CalcDollar[3].val
		}
	case 8:
		CalcDollar = CalcS[Calcpt-3 : Calcpt+1]
//line ./internal/test/test.y:65
		{
			CalcVAL.val = CalcDollar[1].val * CalcDollar[3].val
		}
	case 9:
		CalcDollar = CalcS[Calcpt-3 : Calcpt+1]
//line ./internal/test/test.y:67
		{
			CalcVAL.val = CalcDollar[1].val / CalcDollar[3].val
		}
	case 10:
		CalcDollar = CalcS[Calcpt-3 : Calcpt+1]
//line ./internal/test/test.y:69
		{
			CalcVAL.val = CalcDollar[1].val % CalcDollar[3].val
		}
	case 11:
		CalcDollar = CalcS[Calcpt-3 : Calcpt+1]
//line ./internal/test/test.y:71
		{
			CalcVAL.val = CalcDollar[1].val & CalcDollar[3].val
		}
	case 12:
		CalcDollar = CalcS[Calcpt-3 : Calcpt+1]
//line ./internal/test/test.y:73
		{
			CalcVAL.val = CalcDollar[1].val | CalcDollar[3].val
		}
	case 13:
		CalcDollar = CalcS[Calcpt-2 : Calcpt+1]
//line ./internal/test/test.y:75
		{
			CalcVAL.val = -CalcDollar[2].val
		}
	case 14:
		CalcDollar = CalcS[Calcpt-1 : Calcpt+1]
//line ./internal/test/test.y:77
		{
			CalcVAL.val = regs[CalcDollar[1].val]
		}
	case 16:
		CalcDollar = CalcS[Calcpt-1 : Calcpt+1]
//line ./internal/test/test.y:82
		{
